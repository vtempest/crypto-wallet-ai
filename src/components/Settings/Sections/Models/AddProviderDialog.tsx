...
const AddProvider = ({
  ...
  return (
    <>
      ...
      >
        <DialogContent className="w-full mx-4 lg:w-[600px] max-w-[600px] max-h-[85vh] flex flex-col border bg-light-primary dark:bg-dark-primary border-light-secondary dark:border-dark-secondary rounded-lg p-0">
